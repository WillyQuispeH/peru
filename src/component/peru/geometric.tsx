        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-red-300 via-white/90 to-rose-300 ",
                  pacifico.className
                )}
              >
                {title2}
          ...
          >
            <p className="text-[15px] sm:text-lg md:text-xl text-white mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              ...
              encuentra el comentario PERU hecho por Ibai y dale like.
              ¡Demostremos nuestro sabor al mundo!
            </p>
